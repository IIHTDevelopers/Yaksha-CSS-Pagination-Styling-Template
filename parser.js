...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'ul', 'li', 'a']]
};
...
const cssTestCase = {
    testCaseName: 'CSS pagination Styles Test',
    testCaseType: 'boundary',
...
const requiredStyles2 = [
    {
        ...
        properties: [
            { key: 'margin', value: '0 5px' }
        ]
    }
];

const cssTestCase2 = {
    testCaseName: 'CSS pagination li Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
    extraParams: [requiredStyles2]
};

const requiredStyles3 = [
    {
...
const cssTestCase3 = {
    testCaseName: 'CSS pagination a Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
    extraParams: [requiredStyles3]
};

const requiredStyles4 = [
    {
        selector: 'pagination a:hover',
        properties: [
            { key: 'background-color', value: 'darkblue' },
...
const cssTestCase4 = {
    testCaseName: 'CSS pagination a:hover Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
    extraParams: [requiredStyles4]
};
...
function executeAllTestCases() {
    ...
    handleTestCase(filePath, cssTestCase3.testCaseName, cssTestCase3.testCaseType, cssTestCase3.testLogic, cssTestCase3.extraParams);
    handleTestCase(filePath, cssTestCase4.testCaseName, cssTestCase4.testCaseType, cssTestCase4.testLogic, cssTestCase4.extraParams);
}
